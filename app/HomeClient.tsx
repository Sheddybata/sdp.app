          ...
          <div className="mx-auto max-w-content px-4 py-8 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="home-services-heading" className="mb-12 border-t border-neutral-200 pt-12 sm:mb-14 sm:pt-14">
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <ActionCard href="/enroll/new" imageSrc="/images/enrollement.png" title={t.home.newEnrollment} description={t.home.newEnrollmentDesc} primary aria-label="Start registration" />
